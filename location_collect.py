...
def show_launch_screen():
    ...
    tk.Label(frame, text="GEOCOORDINATE TOOL", font=("Courier", 20, "bold"),
             bg="#0f172a", fg="#3b82f6").pack(pady=(0, 8))
    tk.Label(frame, text="select a mode to continue", font=("Courier", 10),
             bg="#0f172a", fg="#64748b").pack(pady=(0, 40))
 
    tk.Button(frame, text="RECORD DATA", font=("Courier", 14, "bold"),
              bg="#1e293b", fg="#e2e8f0", activebackground="#3b82f6",
              activeforeground="white", relief="flat", cursor="hand2",
              width=24, pady=18, command=build_main_ui).pack(pady=(0, 16))
 
    tk.Button(frame, text="VIEW ANALYTICS", font=("Courier", 14, "bold"),
              bg="#1e293b", fg="#e2e8f0", activebackground="#7c3aed",
              activeforeground="white", relief="flat", cursor="hand2",
              width=24, pady=18, command=lambda: webbrowser.open(os.path.join(BASE_DIR, "analytics.html"))).pack()
...
def build_main_ui():
    ...
    def add_location(coords):
        ...
        clicked_coords.append((lat, lon, today, now))
 ...
 #retrieve data 
    ...
    save_btn = tk.Button(left, text="Add to CSV", bg="#16a34a", fg="white",
    ...
    #tk.Button(left, text="< Back", bg="#0f172a", fg="#64748b",
    #          activebackground="#1e293b", activeforeground="white",
    #          command=show_launch_screen, **btn_style).pack(fill=tk.X, padx=16, pady=(12, 0))
    ...
    map_widget.set_position(-27.475919124999148, 153.0096159909169)
...
if clicked_coords:
    print("\n Session coordinates ")
    for i, (lat, lon, today, now) in enumerate(clicked_coords, 1):
